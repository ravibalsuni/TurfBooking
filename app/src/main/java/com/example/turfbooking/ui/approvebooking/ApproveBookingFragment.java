...
public class ApproveBookingFragment extends Fragment implements ItemClickListener {
    String TEST_URL = Constants.BASE_URL + "/api/turf/booking/search/status/pending";
    int globalPos = 0;
    private FragmentApprovebookingBinding binding;

    TurfBookingModel[] myListData1;

    MyAdapterApproveBooking adapter;
    View root;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        final RecyclerView recyclerView = binding.recyclerViewApprovebooking;
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(root.getContext()));
        adapter = new MyAdapterApproveBooking(myListData1);
    ...
    private class PostAsyncTask extends AsyncTask<String, Void, JSONObject> {
        String UPDATE_URL = Constants.BASE_URL + "/api/turf/booking/update/status";
