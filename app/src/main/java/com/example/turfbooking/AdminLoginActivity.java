...
public class AdminLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etphone = findViewById(R.id.phone_admin);
        etLoginPassword = findViewById(R.id.etLoginPassword_admin);
        loginButton = findViewById(R.id.btnLogin_admin);
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (phone.isEmpty() || password.isEmpty()) {
                    Toast.makeText(AdminLoginActivity.this, "Enter your Email and Password to login", Toast.LENGTH_SHORT).show();
                } else {
                    activity= AdminLoginActivity.this;
                    String response=new GetAsyncTask().doInBackground(phone);
                    System.out.println("response - "+response);
                    if (response != null) {
                        if (response.toString().contains("admin")) {
                            Intent i= new Intent(AdminLoginActivity.this, ApproveTurfActivity.class);
                            final GlobalClass globalVariableA = (GlobalClass) getApplicationContext();
                            globalVariableA.setUserID(phone);
                            globalVariableA.setRole("admin");
                            startActivity(i);
        ...
        tvRegister.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= new Intent(AdminLoginActivity.this, RegisterActivity.class);
                i.putExtra("activity","AdminLoginActivity");
                startActivity(i);
                finish();
            }
        });
